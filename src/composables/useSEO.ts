...
const seoConfigs: Record<string, SEOConfig> = {
  zh: {
    title:
      "头像加圣诞帽 🎄  在线给头像加圣诞帽 - 免费圣诞头像制作工具 | TaurusXin Tools",
    description:
      "免费在线头像加圣诞帽，一键给照片和头像添加圣诞帽。完美适配微信、QQ、抖音等社交平台。想给谁戴圣诞帽就给谁戴！节日氛围拉满，高清无水印下载。",
    keywords:
      "头像加圣诞帽,圣诞头像,加圣诞帽,圣诞帽制作,头像生成器,圣诞节头像,节日头像,微信圣诞头像,QQ圣诞头像,免费圣诞帽工具,抖音圣诞头像,在线图片编辑,Christmas hat generator",
    ogTitle: "头像加圣诞帽 🎄  想给谁戴圣诞帽就给谁戴",
    ogDescription: "免费在线工具，一键给照片添加圣诞帽。节日氛围拉满！",
    ogImage: "https://assets.taurusxin.com/tools/hats/og-image-zh.jpg",
    ogImageAlt: "头像加圣诞帽示例图",
    twitterTitle: "头像加圣诞帽 - 在线给头像加圣诞帽",
    twitterDescription:
      "免费在线头像加圣诞帽，一键给照片和头像添加圣诞帽。",
    twitterImage:
      "https://assets.taurusxin.com/tools/hats/twitter-image-zh.jpg",
    itempropName: "头像加圣诞帽 - 想给谁戴圣诞帽就给谁戴",
    itempropDescription: "免费在线工具，一键给头像加圣诞帽🎄 节日氛围拉满！",
    itempropImage:
      "https://assets.taurusxin.com/tools/hats/wechat-share-zh.jpg",
    lang: "zh-CN",
    ogLocale: "zh_CN",
  ...
  en: {
    title:
      "Christmas Hat Generator 🎄  Add Santa Hat to Photos Online Free | TaurusXin Tools",
    description:
      "Free online Christmas hat generator. Add festive Santa hats to your photos and avatars instantly. Perfect for holiday profile pictures on social media. HD download, no watermark!",
    keywords:
      "Christmas hat generator,Santa hat maker,holiday avatar creator,add Santa hat to photo,Christmas profile picture,festive photo editor,free Christmas hat tool,Santa hat filter",
    ogTitle: "Christmas Hat Generator 🎄  Add Santa Hat to Your Photos",
    ogDescription:
      "Free online tool to add Christmas hats to your photos. Create festive avatars in seconds!",
    ...
    twitterDescription:
      "Free online Christmas hat generator. Add festive Santa hats to your photos instantly!",
    twitterImage:
      "https://assets.taurusxin.com/tools/hats/twitter-image-en.jpg",
    itempropName: "Christmas Hat Generator - Add Santa Hat to Photos",
    itempropDescription:
      "Free online tool. Add Christmas hats to your photos 🎄 ",
    ...
    structuredData: {
      ...
      description:
        "Free online Christmas hat generator. Add festive Santa hats to your photos.",
